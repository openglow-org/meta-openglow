...
#define GF_MMCDEV          EMMC_MMCDEV
#define GF_MMCROOT         EMMC_MMCROOT
#define GF_MMCHWPART       EMMC_MMCHWPART
#define GF_MMCPART         EMMC_MMCPART
#define GF_RECOVERY        "yes"

#define CONFIG_SYS_MMCSD_FS_BOOT_PARTITION GF_MMCPART
#define CONFIG_SYS_MMC_ENV_DEV             GF_MMCDEV
...
#define GF_RECOVERY_IMAGE_SIZE "0x2800" /* 5 MB, 10240 blocks */
...
#define CONFIG_EXTRA_ENV_SETTINGS \
  ...
  "fdt_dev_addr=" GF_RECOVERY_FDT_ADDR "\0" \
  "fdt_size=" GF_RECOVERY_FDT_SIZE "\0" \
  "image_dev_addr=" GF_RECOVERY_IMAGE_ADDR "\0" \
  "image_size=" GF_RECOVERY_IMAGE_SIZE "\0" \
  "boot_fdt=try\0" \
  "boot_recovery=" GF_RECOVERY "\0" \
  "console=" GF_CONSOLE_DEV "\0" \
  "bootm_size=0x10000000\0" \
  "fdt_high=0xffffffff\0"    \
  "initrd_high=0xffffffff\0" \
  "mmcdev=" __stringify(GF_MMCDEV) "\0" \
