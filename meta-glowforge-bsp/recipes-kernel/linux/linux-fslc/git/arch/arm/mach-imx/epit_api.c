 ...
 * the factory 4.14 version is the platform_driver .remove callback, which now
 * returns void. The EPIT gate clocks are already provided by 6.12's clk-imx6q.c
 * and imx6qdl-clock.h, so no clock-tree changes are needed here.
 */
...
static void epit_remove(struct platform_device *pdev)
{
